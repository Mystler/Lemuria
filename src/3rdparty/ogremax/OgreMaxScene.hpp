...
public:
    ...
    virtual void CreatedParticleSystem(const OgreMaxScene *scene, Ogre::ParticleSystem *particleSystem) {
    ...
    virtual void CreatedPlane(const OgreMaxScene *scene, const Ogre::Plane &plane, Ogre::Entity *entity) {
        CreatedMovableObject(scene, entity);
    }
    ...
    virtual Ogre::Camera *GetRenderTextureCamera(const OgreMaxScene *scene, const OgreMax::Types::RenderTextureParameters &renderTextureParameters) {
        return 0;
    }
