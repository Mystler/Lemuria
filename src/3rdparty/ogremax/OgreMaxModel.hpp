...
public:
    ...
    virtual void CreatedLight(const OgreMaxModel *model, Ogre::Light *light) {
        CreatedMovableObject(model, light);
    }
    virtual void CreatedCamera(const OgreMaxModel *model, Ogre::Camera *camera) {
        CreatedMovableObject(model, camera);
    }
    virtual void CreatedMesh(const OgreMaxModel *model, Ogre::Mesh *mesh) {}
    virtual void CreatedEntity(const OgreMaxModel *model, Ogre::Entity *entity) {
        CreatedMovableObject(model, entity);
    }
    virtual void CreatedParticleSystem(const OgreMaxModel *model, Ogre::ParticleSystem *particleSystem) {
        CreatedMovableObject(model, particleSystem);
    }
    virtual void CreatedBillboardSet(const OgreMaxModel *model, Ogre::BillboardSet *billboardSet) {
        CreatedMovableObject(model, billboardSet);
    }
    virtual void CreatedPlane(const OgreMaxModel *model, const Ogre::Plane &plane, Ogre::Entity *entity) {
        CreatedMovableObject(model, entity);
    }
